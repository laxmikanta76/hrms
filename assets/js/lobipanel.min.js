(Math.randomString = function (n) {
  ...
  (String.prototype.getCss = function () {
    for (
      var css = {}, style = this.valueOf().split(";"), i = 0;
      i < style.length;
      i++
    )
  ...
  ($.fn.insertAt = function (i, selector) {
    var object = selector;
    if (
      ("string" == typeof selector && (object = $(selector)),
      (i = Math.min(object.children().length, i)),
      0 == i)
    )
      return object.prepend(this), this;
    ...
    return (
      ...
      object.children().each(function (index, el) {
        var $el = $(el);
        i > oldIndex && index > oldIndex && i >= index
  ...
  $(function () {
    var LobiPanel = function ($el, options) {
      ...
      var $heading,
        ...
        _init = function () {
          ...
          var maxWidth =
            "calc(100% - " +
            $heading.find(".dropdown-menu").children().length *
              $heading.find(".dropdown-menu li").first().outerWidth() +
            "px)";
        ...
        _generateControls = function () {
          ...
          return (
            me.$options.editTitle !== !1 && menu.append(_generateEditTitle()),
        ...
        _getMaxZIndex = function () {
          ...
          max = style
            ? style.getCss()["z-index"]
            : LobiPanel.PRIVATE_OPTIONS.initialZIndex;
        ...
        _onPanelClick = function () {
          me.$el.on("mousedown.lobiPanel", function () {
            return me.isPinned() || me.isMinimized() || me.isOnFullScreen()
              ? !1
              : void me.bringToFront();
          });
        },
        ...
        _changeClassOfControl = function (el) {
          ...
          opts.icon &&
            el
              .find("." + LobiPanel.PRIVATE_OPTIONS.iconClass)
        ...
        _appendInnerIdToParent = function (parent, innerId) {
          if (void 0 === parent.attr(LobiPanel.PRIVATE_OPTIONS.parentAttr))
        ...
        _insertInParent = function () {
          var parent = $(
            "[" + LobiPanel.PRIVATE_OPTIONS.parentAttr + "~=" + innerId + "]"
          );
        ...
        _setBodyHeight = function () {
          "auto" !== me.$options.bodyHeight &&
            $body.css({ height: me.$options.bodyHeight, overflow: "auto" });
        },
        _getOptionsFromAttributes = function () {
          ...
          for (var key in $.fn.lobiPanel.DEFAULTS) {
            ...
            void 0 !== val &&
              (options[key] =
                "object" != typeof $.fn.lobiPanel.DEFAULTS[key]
                  ? val
                  : eval("(" + val + ")"));
          }
          return options;
        ...
        _saveState = function (state) {
          !me.hasRandomId &&
            me.$options.stateful &&
            ((me.storage.state = state), _saveLocalStorage(me.storage));
        },
        _saveLocalStorage = function (storage) {
          localStorage.setItem(
            storagePrefix + innerId,
      ...
      (this.isPanelInit = function () {
        ...
        (this.unpin = function () {
          if (
            (_triggerEvent("beforeUnpin"), me.$el.hasClass("panel-collapsed"))
          )
            return me;
          if (
            (_disableSorting(),
            $heading.find('[data-func="unpin"]').tooltip("hide"),
            me.$el.attr("old-style"))
          )
            ...
            me.$el.css({ left: left, top: top, width: width, height: height });
          }
          ...
          return (
            $body.css({ width: bWidth, height: bHeight }),
        ...
        (this.minimize = function () {
          ...
          if (me.isPinned())
            ...
            var left,
              top,
              footer = _getFooterForMinimizedPanels(),
              children = footer.find(">*");
            if (((top = footer.offset().top), 0 === children.length))
            ...
            me.$el.hasClass("panel-expanded") ||
              ...
              me.$el.animate(
                { left: left, top: top, width: 200, height: footer.height() },
                100,
                function () {
                  me.$el.hasClass("panel-expanded") &&
                  ...
                  var maxWidth =
                    "calc(100% - " +
                    $heading.find(".dropdown-menu li>a:visible").length *
                      $heading
          ...
          if (me.isPinned())
            ...
            me.$el.css({
              ...
              me.$el.animate(css, 100, function () {
                ...
                var maxWidth =
                  "calc(100% - " +
                  $heading.find(".dropdown-menu li").length *
                    $heading.find(".dropdown-menu li").first().outerWidth() +
                  "px)";
                $heading.find(".panel-title").css("max-width", maxWidth),
                  _saveState("unpinned"),
        ...
        (this.toFullScreen = function () {
          ...
          if (me.isPinned() || me.isMinimized()) {
            ...
            var footer = _getFooterForMinimizedPanels();
            0 === footer.children().length && footer.remove();
          } else $body.css({ width: "", height: "" }), _setBodyHeight();
          me.isMinimized()
            ? (me.$el.removeClass("panel-minimized"),
              _removeExpandOnHeaderClick())
            : (me.$el.attr("old-style", me.$el.attr("style")),
          ...
          return (
            me.$el.animate(
              ...
              function () {
                ...
                me.isPinned()
                  ? "auto" !== me.$options.bodyHeight &&
                    ((bHeight = me.$options.bodyHeight), _saveState("pinned"))
        ...
        (this.setPosition = function (left, top) {
          return me.isPinned()
            ? me
            : (me.$el.animate({ left: left, top: top }, 100), me);
        }),
        (this.setWidth = function (w) {
          if (me.isPinned()) return me;
          var bWidth = _calculateBodyWidth(w);
          return (
            me.$el.animate({ width: w }, 100),
            $body.animate({ width: bWidth }, 100),
            me
          );
        }),
        (this.setHeight = function (h) {
          ...
          return (
            me.$el.animate({ height: h }, 100),
            $body.animate({ height: bHeight }, 100),
            me
          );
        }),
        (this.setSize = function (w, h) {
          ...
          return (
            me.$el.animate({ height: h, width: w }, 100),
            $body.animate({ height: bHeight, width: bWidth }, 100),
            me
          );
        }),
        ...
        (this.bringToFront = function () {
          ...
          var res = _getMaxZIndex();
          return res.id === me.$el.data("inner-id")
            ? me
            : (me.$el.css("z-index", res["z-index"] + 1),
        ...
        (this.enableDrag = function () {
          return me.$el.draggable({ handle: ".panel-heading" }), me;
        }),
        (this.disableDrag = function () {
          return (
            me.$el.hasClass("ui-draggable") && me.$el.draggable("destroy"), me
          );
        }),
        (this.enableResize = function () {
          var handles = !1;
          return (
            "vertical" === me.$options.resize
              ? (handles = "n, s")
              : "horizontal" === me.$options.resize
              ? (handles = "e, w")
              : "both" === me.$options.resize && (handles = "all"),
            handles
              ? (me.$el.resizable({
        ...
        (this.disableResize = function () {
          return (
            me.$el.hasClass("ui-resizable") && me.$el.resizable("destroy"), me
          );
        }),
        ...
        (this.load = function (params) {
          (params = params || {}),
            "string" == typeof params && (params = { url: params });
        ...
        (this.startTitleEditing = function () {
          ...
          return (
            input.on("keydown", function (ev) {
              13 === ev.which
                ? me.finishTitleEditing()
                : 27 === ev.which && me.cancelTitleEditing();
            }),
            $heading
              .find(".panel-title")
    ...
    ($.fn.lobiPanel = function (option) {
      ...
      ($.fn.lobiPanel.DEFAULTS = {
        ...
        initialIndex: null,
        stateful: !1,
        unpin: { icon: "glyphicon glyphicon-move", tooltip: "Unpin" },
        reload: { icon: "glyphicon glyphicon-refresh", tooltip: "Reload" },
        minimize: {
        ...
        close: { icon: "glyphicon glyphicon-remove", tooltip: "Close" },
        editTitle: {
