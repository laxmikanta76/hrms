...
/* Salary Setup start ****/
     ...
     public function salary_setupindex()
	{
			 ...
			 return $this->db->select('count(DISTINCT(sstp.e_s_s_id)) as e_s_s_id,sstp.*,p.employee_id,p.*,pos.position_name,dpt.department_name,,MAX(sstp.fixed_amount) as fixed_amount')   
