		...
		if ($this->form_validation->run() === true) {
			...
			{	
				$postData = [
					...
					'calculation_type'      => (!empty($calculation_type[$key])?$calculation_type[$key]:0),
					'create_date'           => $date,
				...
				{ 
					...
					if(!empty($aAmount->employee_id)){
						...
						$accpayable = array(
							...
							'Debit'          => 0,
							'Credit'         => intval(str_replace(',', '', $final_amount)),
							'IsPosted'       => 1,
