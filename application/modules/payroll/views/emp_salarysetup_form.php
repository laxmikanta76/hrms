 <div class="form-group text-right">
     ...
     <a href="<?php echo base_url();?>/payroll/Payroll/emp_salary_setup_view"
                             ...
                             <div class="panel-body">
                                 ...
                                 <div class="form-group row">
                                     <label for="emp_sal_type"
                                         class="col-sm-3 col-form-label"><?php echo display('salary_benefits_type') ?>
                                         *</label>
                                     <div class="col-sm-9">
                                         ...
                                         <select name="emp_sal_type" class="form-control"
                                             placeholder="<?php echo display('salary_benefits_type') ?>"
                                             id="emp_sal_type" style="width:395px">
