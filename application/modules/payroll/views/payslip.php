        ...
        <div class="panel-body" id="payslip">
            ...
            <div class="payslip-inner">
                ...
                <table width="100%" style="border-bottom:2px solid #000;padding-bottom:10px;margin-bottom:10px;">
                    <tr>
                        <td width="15%">
                            <img src="<?php echo base_url('assets/img/icons/accroLogo.png'); ?>" style="width:90px;">
                        </td>
                ...
                <table width="100%" class="footer-address-table" style="border-top:1px solid #000;margin-top:180px;">
                    <tr>
                        <td width="50%">
