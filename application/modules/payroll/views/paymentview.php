                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="panel panel-bd">
                                ...
                                <div class="panel-body">
                                    ...
                                    <!-- NEW: LOP Deduction Field -->
                                    <div class="form-group row">
                                        <label for="lop_deduction" class="col-sm-3 col-form-label">LOP Deduction
                                        </label>
                                        <div class="col-sm-9">
                                            <input type="text" name="lop_deduction" class="form-control"
                                                id="lop_deduction" value="" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="paytype" class="form-control" required="" id="paytype"
                                                onchange="bank_paymet(this.value)" required="" style="width: 100%">
