        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown messages-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span
                        class="label label-success"><?php echo (!empty($notifications->total)?$notifications->total:0) ?></span>
                </a>
                <ul class="dropdown-menu">
                            ...
                            <li>
                                ...
                                <a href="<?php echo base_url("dashboard/message/inbox_information/$message->id") ?>">
                                    <div class="pull-left"><img
                                            src="<?php echo base_url('assets/img/icons/default.jpg') ?>"
                                            class="img-circle" alt="User Image"></div>
                                    <h4><?php echo (!empty($message->sender_name)?$message->sender_name:null) ?><small><i
                                                class="fa fa-clock-o"></i>
                                            <?php echo (!empty($message->datetime)?$message->datetime:null) ?></small>
                                    </h4>
                                    <p><?php echo character_limiter((!empty($message->message)?strip_tags($message->message):null), 30) ?>
                                    </p>
                                </a>
                            </li>
                            <?php } ?>
                    ...
                    <li class="footer"><a
                            href="<?php echo base_url('dashboard/message/index') ?>"><?php echo display('see_all_message') ?></a>
                    </li>
                </ul>
            </li>
            <!-- settings -->
