<div class="sidebar">
    ...
    <div class="user-panel text-center">
        <div class="image">
            ...
            <img src="<?php echo base_url((!empty($image)?$image:'assets/img/icons/mini-logo.png')) ?>"
    ...
    <ul class="sidebar-menu">
     ...
     ksort($HmvcMenu);
        ...
        ************************************* -->
        ...
        <li
            class="treeview <?php echo (($this->uri->segment(1)=="tax" || $this->uri->segment(2)=="user" ||  $this->uri->segment(2)=="language" || $this->uri->segment(2)=="backup_restore" || $this->uri->segment(2)=="role" || $this->uri->segment(2)=="setting" || $this->uri->segment(2)=="message" || $this->uri->segment(2)=="permission_setup")?"active":null) ?>">
            <a href="#">
            ...
            <ul class="treeview-menu">
                ...
                <li class="treeview <?php echo (($this->uri->segment(2)=="Tax")?"active":null) ?>">
                    <a href="<?php echo base_url('tax/Tax/create_tax_setup') ?>">
                ...
                <li class="treeview <?php echo (($this->uri->segment(2)=="message")?"active":null) ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="<?php echo base_url('dashboard/message/sent') ?>"><?php echo display('sent')?></a>
                        </li>
                    </ul>
                </li>
                <?php endif; ?>
