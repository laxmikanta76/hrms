             ...
             <div class="panel-body">
                 ...
                 <div class="form-group row">
                     ...
                     <div class="col-sm-4">
                         ...
                         <span id="enjoy" style="color: red;padding-right: 10px;"></span><span id="checkleave"
                 ...
                 <div class="form-group row">
                     ...
                     <div class="col-sm-4">
                         <input type="text" name="apply_strt_date" class="datepicker form-control apply_start"
                     ...
                     <div class="col-sm-4">
                         <input type="text" name="apply_end_date" class="datepicker form-control apply_end"
