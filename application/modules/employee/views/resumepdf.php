<div class="row">
    <div class="col-sm-12 col-md-4">
        ...
        <div class="card-header">
            ...
            <div> <?php echo "<img src='" . base_url().$row->picture."' width=100px; height=100px; class=img-circle>";?>
            </div>
        </div>
        <div class="card-content">
            <div class="card-content-member">
                <h4 class="m-t-0"><?php echo $row->first_name."  " .$row->last_name;?><span style="color:#F39C12"> <span
            ...
            <div class="card-content-languages">
                ...
                <div class="card-content-languages-group">
                    <table class="table table-hover" width="100%">
                        <caption style="text-align: center; font-size: 25px">
                            <?php echo display('personal_information')?></caption>
                        <tr>
                ...
                <div class="card-content-languages-group">
                    <table class="table table-hover" width="100%">
                        <caption style="text-align: center; font-size: 25px"><?php echo display('biographicalinfo')?>
                        </caption>
                        <tr>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 rating-block">
                ...
                <table class="table table-hover" width="100%">
                    ...
                    <caption style="text-align: center; font-size: 25px"><?php echo display('positional_information')?>
                    </caption>
                    <tr>
