            ...
            <div class="panel-body">
                ...
                <div class="tab-content">
                    ...
                    <div id="checkin" class="tab-pane fade in active">
                        <?= form_open(base_url('attendance/Home/create_atten')) ?>
                        ...
                        <div id="checkout" class="tab-pane fade">
                            <?= form_open(base_url('attendance/Home/checkout')) ?>
                            <input type="hidden" name="punch_type" value="out">
                            <div class="form-group row">
                                <label for="employee_id_out"
                                    class="col-sm-3 col-form-label"><?php echo display('emp_id') ?>
                                    *</label>
                                <div class="col-sm-4">
                                    <?php if (can_select_employee()): ?>
                                    <!-- ADMIN / HR / SUPERVISOR -->
                            ...
                            <div class="form-group row">
                                <label for="outtime"
                                    class="col-sm-3 col-form-label"><?php echo display('time')?>*</label>
                                <div class="col-sm-4">
                ...
                navigator.geolocation.getCurrentPosition(
                    function(position) {
                        ...
                        document.getElementById('location_display_in').value =
                            position.coords.latitude.toFixed(6) + ', ' + position.coords.longitude
                            .toFixed(6);
